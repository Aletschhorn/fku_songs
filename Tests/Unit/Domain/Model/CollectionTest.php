...
/**
 * Test case for class \FKU\FkuSongs\Domain\Model\Collection.
 *
...
{
	/**
	 * @var \FKU\FkuSongs\Domain\Model\Collection
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \FKU\FkuSongs\Domain\Model\Collection();
	}
	...
	{
		$sourceFixture = new \FKU\FkuSongs\Domain\Model\Source();
